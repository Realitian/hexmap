...
(vg.Board = function (e, t) {
    ...
    (vg.HexGrid.prototype = {
        ...
        generateTile: function (e, t, i) {
            ...
            var l = new vg.Tile({ size: this.cellSize, scale: t, cell: e, geometry: n, material: i });
            return (e.tile = l), l;
        },
        generateTiles: function (e) {
            ...
            (i = vg.Tools.merge(i, e)), (this.cellSize = i.cellSize), (this._cellWidth = 2 * this.cellSize), (this._cellLength = 0.5 * vg.SQRT3 * this._cellWidth), (this.autogenerated = !0), (this.extrudeSettings = i.extrudeSettings);
            var s, n, l;
        ...
        generate: function (e) {
            ...
            for (t = -this.size; t < this.size + 1; t++)
                for (i = -this.size; i < this.size + 1; i++) (s = -t - i), Math.abs(t) <= this.size && Math.abs(i) <= this.size && Math.abs(s) <= this.size && ((n = new vg.Cell(t, i, s)), this.add(n));
        },
        ...
        toJSON: function () {
            var e,
                ...
                s = [];
            for (t in this.cells) (e = this.cells[t]), s.push({ q: e.q, r: e.r, s: e.s, h: e.h, walkable: e.walkable, userData: e.userData });
            return (i.cells = s), i;
        },
    ...
    (vg.SqrGrid.prototype = {
        ...
        fromJSON: function (e) {
            var t,
                ...
                s = e.cells;
            for (
                this.cells = {}, this.numCells = 0, this.size = e.size, this.cellSize = e.cellSize, this._fullCellSize = 2 * this.cellSize, this.extrudeSettings = e.extrudeSettings, this.autogenerated = e.autogenerated, t = 0;
                t < s.length;
                t++
            )
                (i = new vg.Cell()), i.copy(s[t]), this.add(i);
    ...
    (vg.Tile = function (e) {
        ...
        this.cell.tile && this.cell.tile !== this && this.cell.tile.dispose(),
            ...
            console.log(this.cell.tile.cell.userData.type ),
            texture = tundra;

        if (this.cell.tile.cell.userData.type == "Tundra") {
            texture = tundra;
        } else if (this.cell.tile.cell.userData.type == "Ice") {
            texture = ice;
        } else if (this.cell.tile.cell.userData.type == "Sea") {
            texture = sea;
        } else if (this.cell.tile.cell.userData.type == "Sand") {
            texture = sand;
        } else if (this.cell.tile.cell.userData.type == "Grassland") {
            texture = grassland;
        } else if (this.cell.tile.cell.userData.type == "Hills") {
            texture = hills;
        } else if (this.cell.tile.cell.userData.type == "Mountain") {
            texture = mountain;
        }
        ...
        (t.generateID = function () {
            ...
            (t.prototype = {
                ...
                remove: function (e) {
                    ...
                    return !t || t.free
                        ? !1
                        : (t.prev && (t.prev.next = t.next), t.next && (t.next.prev = t.prev), t.prev || (this.first = t.next), t.next || (this.last = t.prev), (t.free = !0), (t.prev = null), (t.next = null), this.length--, !0);
                },
                shift: function () {
                    var e = this.first;
        ...
        update: function () {
            if (this.active) {
                ...
                i.length > 0
                    ...
                    this.pickedObject != t &&
                    (this.pickedObject && this.signal.dispatch(vg.MouseCaster.OUT, this.pickedObject), (this.pickedObject = t), (this.selectedObject = null), this.signal.dispatch(vg.MouseCaster.OVER, this.pickedObject)),
    ...
    (vg.Scene = function (e, t) {
        ...
        } else this.camera = new THREE.PerspectiveCamera(50, this.width / this.height, 10, 5e3);
        (this.contolled = !!t),
        this.contolled &&
