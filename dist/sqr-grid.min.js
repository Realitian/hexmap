var vg = { VERSION: "0.1.1", PI: Math.PI, TAU: 2 * Math.PI, DEG_TO_RAD: 0.0174532925, RAD_TO_DEG: 57.2957795, SQRT3: Math.sqrt(3), TILE: "tile", ENT: "entity", STR: "structure", HEX: "hex", SQR: "square", ABS: "abstract" };
(vg.Board = function (t, e) {
    if (!t) throw new Error("You must pass in a grid system for the board to use.");
    (this.tiles = []), (this.tileGroup = null), (this.group = new THREE.Object3D()), (this.grid = null), (this.overlay = null), (this.finder = new vg.AStarFinder(e)), vg.Loader.init(), this.setGrid(t);
}),
    (vg.Board.prototype = {
        setEntityOnTile: function (t, e) {
            var i = this.grid.cellToPixel(e.cell);
            t.position.copy(i), (t.position.y += t.heightOffset || 0), t.tile && (t.tile.entity = null), (t.tile = e), (e.entity = t);
        },
        addTile: function (t) {
            var e = this.tiles.indexOf(t);
            -1 === e && (this.tiles.push(t), this.snapTileToGrid(t), (t.position.y = 0), this.tileGroup.add(t.mesh), this.grid.add(t.cell), (t.cell.tile = t));
        },
        removeTile: function (t) {
            if (t) {
                var e = this.tiles.indexOf(t);
                this.grid.remove(t.cell), -1 !== e && this.tiles.splice(e, 1), t.dispose();
            }
        },
        removeAllTiles: function () {
            if (this.tileGroup) for (var t = this.tileGroup.children, e = 0; e < t.length; e++) this.tileGroup.remove(t[e]);
        },
        getTileAtCell: function (t) {
            var e = this.grid.cellToHash(t);
            return t.tile || ("undefined" != typeof this.grid.cells[e] ? this.grid.cells[e].tile : null);
        },
        ...
        getRandomTile: function () {
            var t = vg.Tools.randomInt(0, this.tiles.length - 1);
            return this.tiles[t];
        },
        ...
        generateOverlay: function (t) {
            ...
            this.overlay && this.group.remove(this.overlay), (this.overlay = new THREE.Object3D()), this.grid.generateOverlay(t, this.overlay, e), this.group.add(this.overlay);
        },
    ...
    (vg.SqrGrid = function (t) {
        (t = t || {}), (this.type = vg.SQR), (this.size = 5), (this.cellSize = "undefined" == typeof t.cellSize ? 10 : t.cellSize), (this.cells = {}), (this.numCells = 0), (this.extrudeSettings = null), (this.autogenerated = !1);
        var e = [];
    ...
    (vg.SqrGrid.prototype = {
        ...
        getNeighbors: function (t, e, i) {
            ...
            for (this._list.length = 0, s = 0; r > s; s++) this._cel.copy(t), this._cel.add(this._directions[s]), (n = this.cells[this.cellToHash(this._cel)]), !n || (i && !i(t, n)) || this._list.push(n);
            if (e) for (s = 0; r > s; s++) this._cel.copy(t), this._cel.add(this._diagonals[s]), (n = this.cells[this.cellToHash(this._cel)]), !n || (i && !i(t, n)) || this._list.push(n);
            return this._list;
        },
        ...
        distance: function (t, e) {
            var i = Math.max(Math.abs(t.q - e.q), Math.abs(t.r - e.r));
            return (i += e.h - t.h);
        },
        clearPath: function () {
            var t, e;
            for (t in this.cells) (e = this.cells[t]), (e._calcCost = 0), (e._priority = 0), (e._parent = null), (e._visited = !1);
        },
        traverse: function (t) {
            var e;
        ...
        generateTile: function (t, e, i) {
            ...
            var r = new vg.Tile({ size: this.cellSize, scale: e, cell: t, geometry: n, material: i });
            return (t.tile = r), r;
        },
        generateTiles: function (t) {
            ...
            (i = vg.Tools.merge(i, t)), (this.cellSize = i.cellSize), (this._fullCellSize = 2 * this.cellSize), (this.autogenerated = !0), (this.extrudeSettings = i.extrudeSettings);
            var s, n, r;
            for (s in this.cells) (r = this.cells[s]), (n = this.generateTile(r, i.tileScale, i.material)), n.position.copy(this.cellToPixel(r)), (n.position.y = 0), e.push(n);
            return e;
        },
        generateTilePoly: function (t) {
            t || (t = new THREE.MeshBasicMaterial({ color: 2405631 }));
            var e = new THREE.Mesh(this.cellShapeGeo, t);
            return this._vec3.set(1, 0, 0), e.rotateOnAxis(this._vec3, vg.PI / 2), e;
        },
        generate: function (t) {
            (t = t || {}), (this.size = "undefined" == typeof t.size ? this.size : t.size);
            var e,
                i,
                s,
                n = Math.ceil(this.size / 2);
            for (e = -n; n > e; e++) for (i = -n; n > i; i++) (s = new vg.Cell(e, i + 1)), this.add(s);
        },
        generateOverlay: function (t, e, i) {
            ...
            for (s = -r; r > s; s++)
                for (n = -r; r > n; n++) {
                    this._cel.set(s, n);
                    var o = new THREE.Line(this.cellGeo, i);
                    o.position.copy(this.cellToPixel(this._cel)), (o.rotation.x = 90 * vg.DEG_TO_RAD), e.add(o);
                }
        },
        add: function (t) {
        ...
        fromJSON: function (t) {
            var e,
                ...
                s = t.cells;
            for (
                this.cells = {}, this.numCells = 0, this.size = t.size, this.cellSize = t.cellSize, this._fullCellSize = 2 * this.cellSize, this.extrudeSettings = t.extrudeSettings, this.autogenerated = t.autogenerated, e = 0;
                e < s.length;
                e++
            )
                (i = new vg.Cell()), i.copy(s[e]), this.add(i);
        },
        toJSON: function () {
            var t,
                e,
                ...
                s = [];
            for (e in this.cells) (t = this.cells[e]), s.push({ q: t.q, r: t.r, s: t.s, h: t.h, walkable: t.walkable, userData: t.userData });
            return (i.cells = s), i;
        },
    }),
    ...
    (vg.Tile = function (t) {
        ...
        if (((e = vg.Tools.merge(e, t)), !e.cell || !e.geometry)) throw new Error("Missing vg.Tile configuration");
        (this.cell = e.cell),
            ...
            this.material || (this.material = new THREE.MeshPhongMaterial({ color: vg.Tools.randomizeRGB("30, 30, 30", 13) })),
            ...
            (e.prototype = {
                ...
                add: function (t) {
                    ...
                    if (this.first) {
                        ...
                        (this.last.next = e), (e.prev = this.last), (this.last = e), (e.next = null);
                    } else (this.first = e), (this.last = e), (e.next = null), (e.prev = null);
                ...
                moveUp: function (t) {
                    ...
                    if (e.prev) {
                        ...
                        var n = e.next;
                        s && (s.next = e), (e.next = i), (e.prev = i.prev), (i.next = n), (i.prev = e), this.first == i && (this.first = e);
                    }
                },
                moveDown: function (t) {
                    var e = this.getNode(t);
                ...
                sort: function (t) {
                    ...
                    for (this.clear(), s.sort(t), i = s.length, e = 0; i > e; e++) this.add(s[e]);
                },
                remove: function (t) {
                    var e = this.getNode(t);
                    return !e || e.free
                        ? !1
                        : (e.prev && (e.prev.next = e.next), e.next && (e.next.prev = e.prev), e.prev || (this.first = e.next), e.next || (this.last = e.prev), (e.free = !0), (e.prev = null), (e.next = null), this.length--, !0);
                },
                shift: function () {
                    var t = this.first;
                    return 0 === this.length
                        ? null
                        : (t.prev && (t.prev.next = t.next), t.next && (t.next.prev = t.prev), (this.first = t.next), t.next || (this.last = null), (t.free = !0), (t.prev = null), (t.next = null), this.length--, t.obj);
                },
                pop: function () {
                    var t = this.last;
                    return 0 === this.length
                        ? null
                        : (t.prev && (t.prev.next = t.next), t.next && (t.next.prev = t.prev), (this.last = t.prev), t.prev || (this.first = null), (t.free = !0), (t.prev = null), (t.next = null), this.length--, t.obj);
                },
                concat: function (t) {
                ...
                dump: function (t) {
                    console.log("====================" + t + "=====================");
                    for (var e = this.first; e; ) console.log("{" + e.obj.toString() + "} previous=" + (e.prev ? e.prev.obj : "NULL")), (e = e.next());
    ...
    (function () {
        var t = function (t, e, i, s, n) {
            (this._listener = e), (this.isOnce = i), (this.context = s), (this.signal = t), (this._priority = n || 0);
        };
        (t.prototype = {
            active: !0,
            params: null,
            execute: function (t) {
                var e, i;
                return this.active && this._listener && ((i = this.params ? this.params.concat(t) : t), (e = this._listener.apply(this.context, i)), this.isOnce && this.detach()), e;
            },
            detach: function () {
        ...
        (e.prototype = {
            ...
            _registerListener: function (e, i, s, n) {
                var r,
                    o = this._indexOfListener(e, s);
                if (-1 !== o) {
                    if (((r = this._bindings[o]), r.isOnce !== i)) throw new Error("You cannot add" + (i ? "" : "Once") + "() then add" + (i ? "Once" : "") + "() the same listener without removing the relationship first.");
                } else (r = new t(this, e, i, s, n)), this._addBinding(r);
    ...
    (vg.AStarFinder = function (t) {
        t = t || {};
        var e = { allowDiagonal: !1, heuristicFilter: null };
        (e = vg.Tools.merge(e, t)), (this.allowDiagonal = e.allowDiagonal), (this.heuristicFilter = e.heuristicFilter), (this.list = new vg.LinkedList());
    }),
    (vg.AStarFinder.prototype = {
        findPath: function (t, e, i, s) {
            var n, r, o, l, h, a;
            for (i = i || this.heuristicFilter, s.clearPath(), this.list.clear(), this.list.add(t); this.list.length > 0; ) {
                if ((this.list.sort(this.compare), (n = this.list.shift()), (n._visited = !0), n === e)) return vg.PathUtil.backtrace(e);
                for (o = s.getNeighbors(n, this.allowDiagonal, i), h = 0, a = o.length; a > h; h++)
                    if (((l = o[h]), l.walkable && ((r = n._calcCost + s.distance(n, l)), !l._visited || r < l._calcCost))) {
                        if (((l._visited = !0), (l._parent = n), (l._calcCost = r), (l._priority = r + s.distance(e, l)), l === e)) return vg.PathUtil.backtrace(e);
                        this.list.add(l);
                    }
            }
            return null;
    ...
    (vg.PathUtil = {
        ...
        pathLength: function (t) {
            var e,
                ...
                r,
                o = 0;
            for (e = 1; e < t.length; ++e) (i = t[e - 1]), (s = t[e]), (n = i[0] - s[0]), (r = i[1] - s[1]), (o += Math.sqrt(n * n + r * r));
            return o;
        },
        interpolate: function (t, e, i, s) {
            var n,
                r,
                o,
                l,
                ...
                c = Math.abs,
                u = [];
            for (o = c(i - t), l = c(s - e), n = i > t ? 1 : -1, r = s > e ? 1 : -1, h = o - l; t !== i || e !== s; ) u.push([t, e]), (a = 2 * h), a > -l && ((h -= l), (t += n)), o > a && ((h += o), (e += r));
            return u;
        },
        expandPath: function (t) {
            var e,
                ...
                h = t.length;
            if (2 > h) return l;
            for (r = 0; h - 1 > r; ++r) for (e = t[r], i = t[r + 1], s = this.interpolate(e[0], e[1], i[0], i[1]), n = s.length, o = 0; n - 1 > o; ++o) l.push(s[o]);
        ...
        smoothenPath: function (t, e) {
            var i,
                ...
                m = e[p - 1][0],
                w = e[p - 1][1];
            for (i = f, s = v, o = [[i, s]], h = 2; p > h; ++h) {
                for (c = e[h], n = c[0], r = c[1], u = this.interpolate(i, s, n, r), g = !1, a = 1; a < u.length; ++a)
                    if (((d = u[a]), !t.isWalkableAt(d[0], d[1]))) {
                        g = !0;
                        break;
                    }
                g && ((l = e[h - 1]), o.push(l), (i = l[0]), (s = l[1]));
            }
            return o.push([m, w]), o;
        },
        compressPath: function (t) {
            ...
            var e,
                ...
                d = c - h,
                g = u - a;
            for (r = Math.sqrt(d * d + g * g), d /= r, g /= r, l.push([h, a]), o = 2; o < t.length; o++)
                (e = c), (i = u), (s = d), (n = g), (c = t[o][0]), (u = t[o][1]), (d = c - e), (g = u - i), (r = Math.sqrt(d * d + g * g)), (d /= r), (g /= r), (d !== s || g !== n) && l.push([e, i]);
            return l.push([c, u]), l;
        },
    }),
    (vg.Loader = {
        ...
        loadTexture: function (t, e, i, s) {
            var n = new THREE.Texture(null, e);
            return (
    ...
    (vg.MouseCaster.prototype = {
        update: function () {
            if (this.active) {
                ...
                i.length > 0
                    ? ((t = i[0]),
                      (e = t.object.userData.structure),
                      this.pickedObject != e &&
                          (this.pickedObject && this.signal.dispatch(vg.MouseCaster.OUT, this.pickedObject), (this.pickedObject = e), (this.selectedObject = null), this.signal.dispatch(vg.MouseCaster.OVER, this.pickedObject)),
                      this.position.copy(t.point),
                      (this.screenPosition.z = t.distance))
                    : (this.pickedObject && this.signal.dispatch(vg.MouseCaster.OUT, this.pickedObject), (this.pickedObject = null), (this.selectedObject = null)),
                    (this.allHits = i);
            }
        },
            ...
            return (
                ...
                this._preventDefault
                    ...
                    : ((this.shift = t.shiftKey),
                      ...
                      (this.down = 1 === t.which ? !1 : this.down),
                      void (this.rightDown = 3 === t.which ? !1 : this.rightDown))
            );
        },
        _onDocumentMouseMove: function (t) {
            t.preventDefault(), (this.screenPosition.x = (t.clientX / window.innerWidth) * 2 - 1), (this.screenPosition.y = 2 * -(t.clientY / window.innerHeight) + 1);
        },
        _onMouseWheel: function (t) {
            if (this.active) {
                t.preventDefault(), t.stopPropagation();
                var e = 0;
                void 0 !== t.wheelDelta ? (e = t.wheelDelta) : void 0 !== t.detail && (e = -t.detail), e > 0 ? this.wheel++ : this.wheel--, this.signal.dispatch(vg.MouseCaster.WHEEL, this.wheel);
            }
        },
    }),
    (vg.MouseCaster.prototype.constructor = vg.MouseCaster),
    (vg.Scene = function (t, e) {
        var i = {
            ...
            s = { minDistance: 100, maxDistance: 1e3, zoomSpeed: 2, noZoom: !1 };
        if (
            ((i = vg.Tools.merge(i, t)),
            "boolean" != typeof e && (s = vg.Tools.merge(s, e)),
            ...
            var n = window.innerWidth / this.orthoZoom,
                r = window.innerHeight / this.orthoZoom;
            this.camera = new THREE.OrthographicCamera(n / -2, n / 2, r / 2, r / -2, 1, 5e3);
            ...
            window.addEventListener(
                ...
                function () {
                    if (((this.width = window.innerWidth), (this.height = window.innerHeight), "OrthographicCamera" === this.camera.type)) {
                        ...
                        (this.camera.left = t / -2), (this.camera.right = t / 2), (this.camera.top = e / 2), (this.camera.bottom = e / -2);
    ...
    (vg.SelectionManager = function (t) {
        (this.mouse = t), (this.onSelect = new vg.Signal()), (this.onDeselect = new vg.Signal()), (this.selected = null), (this.toggleSelection = !1), this.mouse.signal.add(this.onMouse, this);
    }),
    ...
    (vg.Tools = {
        ...
        random: function (t, e) {
            return 1 === arguments.length ? Math.random() * t - 0.5 * t : Math.random() * (e - t) + t;
        },
        randomInt: function (t, e) {
            return 1 === arguments.length ? (Math.random() * t - 0.5 * t) | 0 : (Math.random() * (e - t + 1) + t) | 0;
        },
            ...
            return s
                ? ((t = t || []),
                  ...
                  e.forEach(function (e, s) {
                      "undefined" == typeof n[s] ? (n[s] = e) : i.isPlainObject(e) ? (n[s] = i.merge(t[s], e)) : -1 === t.indexOf(e) && n.push(e);
                  }),
                  n)
                : (t &&
                      i.isPlainObject(t) &&
                  ...
                  Object.keys(e).forEach(function (s) {
                      e[s] && i.isPlainObject(e[s]) && t[s] ? (n[s] = i.merge(t[s], e[s])) : (n[s] = e[s]);
                  }),
                  n);
        },
        now: function () {
        ...
        radixSort: function (t, e, i, s) {
            if (((e = e || 0), (i = i || t.length), (s = s || 31), !(e >= i - 1 || 0 > s))) {
                for (var n = e, r = i, o = 1 << s; r > n; )
                    if (t[n] & o) {
                        --r;
                        var l = t[n];
                        (t[n] = t[r]), (t[r] = l);
                    } else ++n;
                this.radixSort(t, e, r, s - 1), this.radixSort(t, r, i, s - 1);
            }
        },
        randomizeRGB: function (t, e) {
            var i,
                ...
                n = t.split(","),
                r = "rgb(";
            for (e = this.randomInt(e), i = 0; 3 > i; i++) (s = parseInt(n[i]) + e), 0 > s ? (s = 0) : s > 255 && (s = 255), (r += s + ",");
            return (r = r.substring(0, r.length - 1)), (r += ")");
        },
        getJSON: function (t) {
            var e = new XMLHttpRequest(),
                i = "undefined" == typeof t.cache ? !1 : t.cache,
                s = i ? t.url : t.url + "?t=" + Math.floor(1e4 * Math.random()) + Date.now();
